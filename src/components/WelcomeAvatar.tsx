 ...
 * Features Dilar's half-body photo with CSS/Framer-Motion animations:
 *   • Entrance slide-up  
 *   • Waving hand (looped)  
...
export default function WelcomeAvatar({ onEnterChat, onClose }: Props) {
  ...
  return (
    <motion.div
      ...
      className="relative w-[290px] sm:w-[310px] rounded-3xl overflow-hidden shadow-[0_32px_80px_-12px_rgba(0,87,168,0.45)] border border-white/40 flex flex-col"
      style={{
    ...
    >
      ...
      <div className="relative h-[230px] sm:h-[250px] shrink-0 overflow-hidden"
      ...
      >
        ...
        <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-full flex justify-center items-end">
          ...
          >
            ...
            {/* Dilar's image — COMPACT SCALE TO FIT ALL VIEWPORTS */}
            <motion.img
      ...
      <div className="relative bg-white px-5 pt-4 pb-5">
            ...
            >
              <div className="bg-gradient-to-br from-[#EAF6FF] to-white border border-[#009FE3]/20 rounded-2xl rounded-tl-sm px-4 py-3 shadow-sm">
                <p className="text-sm font-bold text-[#0A2540] leading-snug">
                  <Typewriter text="Olá! 👋 Bem-vindo ao site da Dilar Horta!" delay={200} />
                </p>
        ...
        <div className="flex items-center gap-3 mb-4">
          <div className="w-11 h-11 rounded-full overflow-hidden border-2 border-[#009FE3]/30 shrink-0">
            <img src="/images/1-removebg-preview.png" alt="Dilar" className="w-full h-full object-cover" style={{ objectPosition: "50% 8%" }} />
          </div>
          <div>
            <p className="font-bold text-[#0A2540] text-sm">Dilar Horta</p>
