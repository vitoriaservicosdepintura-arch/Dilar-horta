      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8 grid lg:grid-cols-2 gap-14 items-center">
        ...
        >
          ...
          <h2 className="font-display text-4xl sm:text-5xl font-bold text-[#0A2540] mt-4 leading-tight">
            {content.valuesContent?.title || "Mais do que consultoria,"} <br />
            <span className="text-gradient">{content.valuesContent?.subtitle || "uma parceria para a vida."}</span>
          </h2>
          <p className="mt-4 text-slate-600 text-lg max-w-lg">
            {content.valuesContent?.description || "O sucesso de um investimento começa na clareza do propósito e na confiança de quem o guia."}
          </p>
        ...
        >
          ...
          >
            ...
            <p className="relative z-10 text-white text-lg font-medium italic leading-relaxed">
              “{content.valuesContent?.quote || "Vender ou comprar uma casa não é apenas um negócio, é a construção de um novo capítulo. O meu propósito é garantir que cada passo dessa jornada seja seguro, transparente e repleto de conquistas."}”
            </p>
            ...
            <div className="mt-6 flex items-center gap-4 relative z-10">
              ...
              <div>
                <p className="text-sm font-bold text-white uppercase tracking-widest text-gradient bg-white">Dilar Horta</p>
