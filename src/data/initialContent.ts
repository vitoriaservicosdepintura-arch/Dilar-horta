...
export interface ContentState {
    ...
    assistantConfig: {
        ...
        accent: "pt-PT" | "pt-BR" | "en-US" | "es-ES";
...
export const INITIAL_CONTENT: ContentState = {
    hero: {
        ...
        description: "Com a Dilar Horta, garantimos uma consultoria de excelência para encontrar o seu imóvel ideal e investir com total segurança, concretizando os seus objetivos no mercado imobiliário em Portugal.",
        portraitUrl: "/images/1-removebg-preview.png",
    },
    options: {
    ...
    leadCapture: {
        image: "/images/foto-linha-2.png"
    },
    servicesContent: {
        title: "Como Posso Ajudar",
        description: "Soluções imobiliárias completas e personalizadas para cada cliente.",
        images: []
    },
    valuesContent: {
        title: "Mais do que consultoria,",
        subtitle: "uma parceria para a vida.",
        description: "O sucesso de um investimento começa na clareza do propósito e na confiança de quem o guia.",
        quote: "Vender ou comprar uma casa não é apenas um negócio, é a construção de um novo capítulo. O meu propósito é garantir que cada passo dessa jornada seja seguro, transparente e repleto de conquistas.",
        images: []
    },
    assistantConfig: {
        isActive: true,
        voiceGender: "female",
        accent: "pt-PT",
        whatsappNumber: "351939103038" // Default from VirtualAssistant
    },
    properties: [
        {
            id: 'casa-1',
    ...
    knowledgeBase: [
        {
            ...
            answer: "Olá! 👋 Sou a assistente virtual da **Dilar Horta**, consultora imobiliária da **RE/MAX Dinâmica**. Estou aqui para o ajudar a encontrar o imóvel ideal, esclarecer dúvidas sobre compra, venda ou investimento em Portugal. Como posso ajudar? 😊",
